<x-guest-layout>
    <x-auth-card>
        <x-slot name="logo">
            <a href="/">
                <svg viewBox="0 0 90 20" preserveAspectRatio="xMidYMid meet" focusable="false" class="h-48 w-48">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <!-- Channel Name -->
            <div class="mt-4">
                <x-label for="channel_name" :value="__('Channel Name')" />

                <x-input id="channel_name" class="block mt-1 w-full" type="text" name="channel_name" :value="old('channel_name')"
                    required />
            </div>
