        ...
        <div class="flex justify-between h-16">
            <div class="flex flex-row items-center gap-x-4">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="/"><svg viewBox="0 0 90 20" preserveAspectRatio="xMidYMid meet" focusable="false"
                        class="h-24 w-24">
                ...
                @auth
                <div class="flex-1">
                    <a class="font-bold text-lg" href="{{ route('video.all',[auth()->user()->channel->slug]) }}">
                        All Videos
                    </a>
                </div>
                @endauth
            ...
            <div class="flex flex-row items-center justify-between">
                <!-- Icon -->
                @auth
                <a href="{{ route('video.create', [auth()->user()->channel->slug]) }}" class="flex items-center">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                        @auth
                            <x-dropdown-link :href="route('index.channel', ['channel' => auth()->user()->channel->slug])">
